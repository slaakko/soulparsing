...
#ifndef SOUL_PARSING_ACTION_INCLUDED
#define SOUL_PARSING_ACTION_INCLUDED
...
public:
    ...
    ActionParser(const std::u32string& name_, soul::codedom::CompoundStatement* successCode_, Parser* child_);
    ActionParser(const std::u32string& name_, soul::codedom::CompoundStatement* successCode_, soul::codedom::CompoundStatement* failCode_, 
        Parser* child_);
    virtual bool IsActionParser() const { return true; }
    std::u32string MethodName() const;
    std::u32string VariableName() const;
    soul::codedom::CompoundStatement* SuccessCode() const { return successCode.get(); }
    soul::codedom::CompoundStatement* FailCode() const { return failCode.get(); }
...
private:
    std::unique_ptr<soul::codedom::CompoundStatement> successCode;
    std::unique_ptr<soul::codedom::CompoundStatement> failCode;
...
#endif // SOUL_PARSING_ACTION_INCLUDED
