...
#ifndef SOUL_PARSING_PARSING_DATA_INCLUDED
#define SOUL_PARSING_PARSING_DATA_INCLUDED
#include <soul_u32/util/Error.hpp>
#include <memory>
#include <stack>
#include <vector>
...
#endif // SOUL_PARSING_PARSING_DATA_INCLUDED
