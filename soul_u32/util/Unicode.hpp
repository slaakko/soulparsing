...
#ifndef SOUL_UNICODE_UNICODE_INCLUDED
#define SOUL_UNICODE_UNICODE_INCLUDED
#include <soul_u32/util/BinaryWriter.hpp>
#include <soul_u32/util/BinaryReader.hpp>
#include <string>
#include <vector>
...
public:
    ...
    const std::vector<Script>& Scipts() const { return scripts; }
private:
...
const uint8_t current_soul_ucd_version = soul_ucd_version_1;
...
} } // namespace soul::unicode

#endif // SOUL_UNICODE_UNICODE_INCLUDED
